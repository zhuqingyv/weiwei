...
if (reversed == null) { reversed = false; }
	...
	// 不动内容
	this.谱面讲解 = new lib.an_Video({'id': '谱面讲解', 'src':'videos/1.闪烁的小星星范唱.mp4', 'autoplay':false, 'controls':true, 'muted':false, 'loop':false, 'poster':'', 'preload':true, 'class':'video'});

	this.谱面讲解.name = "谱面讲解";
	this.谱面讲解.setTransform(1111.45,515.5,3.625,2.6667,0,0,0,200,150);

	this.节奏练习 = new lib.an_Video({'id': '节奏练习', 'src':'videos/2.闪烁的小星星伴奏.mp4', 'autoplay':false, 'controls':true, 'muted':false, 'loop':false, 'poster':'', 'preload':true, 'class':'video'});
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1693894849092", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1693894849092", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1693894849092", id:"an.Video"}
	],
	preloads: []
};
