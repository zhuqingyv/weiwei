...
// stage content:
(lib.三 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = false; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {m1:3,m2:638};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);

	this.actionFrames = [0,3,635,638,744];
	this.streamSoundSymbolsList[3] = [{id:"yx12160301听辨声音高",startFrame:3,endFrame:638,loop:1,offset:0}];
	this.streamSoundSymbolsList[638] = [{id:"yx12160302听辨音高",startFrame:638,endFrame:745,loop:1,offset:0}];
	// timeline functions:
	...
	this.frame_3 = function() {
		var soundInstance = playSound("yx12160301听辨声音高",0);
		this.InsertIntoSoundStreamData(soundInstance,3,638,1);
		var _this = this;
	...
	this.frame_638 = function() {
		var soundInstance = playSound("yx12160302听辨音高",0);
		this.InsertIntoSoundStreamData(soundInstance,638,745,1);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(3).call(this.frame_3).wait(632).call(this.frame_635).wait(3).call(this.frame_638).wait(106).call(this.frame_744).wait(1));
	...
	this.m2stop.setTransform(1137.1,582.75);
	new cjs.ButtonHelper(this.m2stop, 0, 1, 2, false, new lib.音频停止(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.m1stop}]},3).to({state:[{t:this.m2stop}]},635).wait(107));

	// 音频播放标
	this.m2 = new lib.音频播放标();
	this.m2.name = "m2";
	this.m2.setTransform(1122.65,585.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.m1},{t:this.m2}]}).to({state:[{t:this.m2}]},3).to({state:[{t:this.m1}]},635).wait(107));
	...
	this.shape.setTransform(1069.575,636.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#51C1E1").s().p("Ai/DdIAAjRIGBAAIAACuQAAAMgDAGQgEAGgIADQgKACgPABIgmABIgFgMIgFgMIAeABIASgBQAFAAABgCQACgBAAgEIAAiTIlCAAIAAC2gAhnDAIAAh6IDKAAIAABiIirAAIAAAYgAhICPICOAAIAAgwIiOAAgAiGgPIAAhfIETAAIAABfgAhngnIDTAAIAAgvIjTAAgAjSiLIAAgcIDJAAIgHgXIgIgXIAcgGIALAbIAJAZIC6AAIAAAcg");
	this.shape_1.setTransform(1033.4,636.35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#51C1E1").s().p("");
	this.shape_2.setTransform(985.15,636.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#51C1E1").s().p("AgQDcIAAksIAfAAIAAEsgACBgpQgjgYgggdQgggdgeglQgnAzg0AqQgyApg6AaIgKgNIgNgOQAugVAqgdQAqgdAkglQAjgkAYgoIAcANIgHAKIgGAKQAsA3AzAmQAzAmA7AcIgMAOQgHAIgEAGQgmgTghgXg");
	this.shape_3.setTransform(936.9,636.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#51C1E1").s().p("");
	this.shape_4.setTransform(889,637.625);
	...
	this.shape_5.setTransform(840.725,636.525);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#51C1E1").s().p("AjaARIAAgiIG1AAIAAAig");
	this.shape_6.setTransform(791.775,636);
	...
	this.shape_7.setTransform(744.025,636.525);
	...
	this.shape_10.setTransform(1107.175,516.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#51C1E1").s().p("Ai/DdIAAjRIGBAAIAACtQABANgEAFQgEAHgJADQgIACgQACIgmAAIgEgNIgGgLIAeAAIASAAQAEAAACgBQACgCAAgEIAAiSIlCAAIAAC1gAhmDBIAAh7IDJAAIAABhIisAAIAAAagAhJCPICPAAIAAgxIiPAAgAiHgOIAAhgIEUAAIAABggAhmgnIDRAAIAAguIjRAAgAjSiLIAAgcIDIAAIgGgXIgIgWIAcgHIALAaIAJAaIC7AAIAAAcg");
	this.shape_11.setTransform(1071,516.15);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#51C1E1").s().p("");
	this.shape_12.setTransform(1022.75,516.1);
	...
	this.shape_13.setTransform(973.425,516.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#51C1E1").s().p("AgRDcIAAksIAhAAIAAEsgACAgpQgigXgggeQgggdgeglQgnAzgzApQg0Aqg4AbIgLgPIgNgNQAtgUArgeQArgeAjgjQAjglAXgoIAdANIgGALIgHAKQAsA2A0AmQAyAmA7AdIgNANQgGAHgEAIQglgUgjgXg");
	this.shape_14.setTransform(926.15,516.25);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#51C1E1").s().p("");
	this.shape_15.setTransform(878.25,517.425);
	...
	this.shape_16.setTransform(829.975,516.325);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#51C1E1").s().p("AjaASIAAgiIG1AAIAAAig");
	this.shape_17.setTransform(781.025,515.8);
	...
	this.shape_18.setTransform(733.275,516.325);
	...
	this.shape_21.graphics.f("#E28623").s().p("");
	this.shape_21.setTransform(934.775,404.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#E28623").s().p("");
	this.shape_22.setTransform(886.35,403.975);
	...
	this.shape_26.graphics.f("#E28623").s().p("AjQC8IAAg7IGhAAIAAA7gAiUAZIAAg6IElAAIAAA6gAi1iBIAAg6IFuAAIAAA6g");
	this.shape_26.setTransform(692.875,405.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(745));
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"sounds/yx12160301听辨声音高.mp3?1693896256568", id:"yx12160301听辨声音高"},
		{src:"sounds/yx12160302听辨音高.mp3?1693896256568", id:"yx12160302听辨音高"}
	],
	preloads: []
};
