...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {m1:3,m2:101};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);

	this.actionFrames = [0,3,98,101,196];
	this.streamSoundSymbolsList[3] = [{id:"yx12160201听辨声音长",startFrame:3,endFrame:101,loop:1,offset:0}];
	this.streamSoundSymbolsList[101] = [{id:"yx12160202听辨音长",startFrame:101,endFrame:197,loop:1,offset:0}];
	// timeline functions:
	...
	this.frame_3 = function() {
		var soundInstance = playSound("yx12160201听辨声音长",0);
		this.InsertIntoSoundStreamData(soundInstance,3,101,1);
		var _this = this;
	...
	this.frame_101 = function() {
		var soundInstance = playSound("yx12160202听辨音长",0);
		this.InsertIntoSoundStreamData(soundInstance,101,197,1);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(3).call(this.frame_3).wait(95).call(this.frame_98).wait(3).call(this.frame_101).wait(95).call(this.frame_196).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.m1stop}]},3).to({state:[{t:this.m2stop}]},98).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.m1},{t:this.m2}]}).to({state:[{t:this.m2}]},3).to({state:[{t:this.m1}]},98).wait(96));
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#51C1E1").s().p("");
	this.shape_1.setTransform(1023.275,636.45);
	...
	this.shape_11.graphics.f("#51C1E1").s().p("");
	this.shape_11.setTransform(1071.625,516.25);
	...
	this.shape_21.graphics.f("#E28623").s().p("");
	this.shape_21.setTransform(934.65,403.975);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#E28623").s().p("");
	this.shape_22.setTransform(887.05,404.075);
	...
	this.shape_26.graphics.f("#E28623").s().p("AjWCsIAAhCIGtAAIAABCgAithsIAAg/IFcAAIAAA/g");
	this.shape_26.setTransform(693.025,405.5);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"sounds/yx12160201听辨声音长.mp3?1693896231782", id:"yx12160201听辨声音长"},
		{src:"sounds/yx12160202听辨音长.mp3?1693896231782", id:"yx12160202听辨音长"}
	],
	preloads: []
};
